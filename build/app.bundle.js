...
var _Title = __webpack_require__(41);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'TodoApp' },
                _react2.default.createElement(_Title2.default, { className: 'TodoTitle', todoNumber: this.state.data.length }),
                _react2.default.createElement(_TodoList2.default, { className: 'TodoListStyle', data: this.state.data, remove: this.removeTodo.bind(this) })
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./Title.sass", (function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./Title.sass");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		}));
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./TodoList.sass", (function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./TodoList.sass");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		}));
	}
...
// module
exports.push([module.i, ".TodoListStyle {\n  background-color: #fff; }\n  .TodoListStyle ul {\n    padding: 15px;\n    width: 200px; }\n    .TodoListStyle ul li {\n      text-transform: uppercase;\n      margin: 5px;\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: space-between; }\n      .TodoListStyle ul li button {\n        border: none;\n        background-color: #ff0000; }\n", ""]);
